...
public class PieChartGenerationTest {
    ...
    public void testPieChartCreationWithTitle() {
        ...
        assertNotNull(chart);
        assertTrue(chart.getTitle() instanceof TextTitle);
    ...
    public void testPieChartCreationWithTooltips() {
        ...
        assertNotNull(chart);
        assertTrue(((PiePlot) chart.getPlot()).getToolTipGenerator() != null);
    }
    ...
    public void testPieChartCreationWithURLGeneration() {
        ...
        assertNotNull(chart);
        assertTrue(((PiePlot) chart.getPlot()).getURLGenerator() != null);
    }
    ...
    public void testPieChartCreationWithZeroValueDataPoint() {
        DefaultPieDataset dataset = new DefaultPieDataset();
        dataset.setValue("One", valueOf(0.0));
    ...
    public void testPieChartCreationWithDataPointsSumTo100() {
        DefaultPieDataset dataset = new DefaultPieDataset();
        dataset.setValue("One", valueOf(20.0));
        dataset.setValue("Two", valueOf(30.0));
        dataset.setValue("Three", valueOf(50.0));
    ...
    public void testPieChartCreationWithDataPointsExceed100() {
        DefaultPieDataset dataset = new DefaultPieDataset();
        dataset.setValue("One", valueOf(60.0));
        dataset.setValue("Two", valueOf(60.0));
    ...
    public void testPieChartCreationWithDataPointsLessThan100() {
        DefaultPieDataset dataset = new DefaultPieDataset();
        dataset.setValue("One", valueOf(30.0));
        dataset.setValue("Two", valueOf(30.0));
    ...
    public static class PieTest {
        ...
        public void testCreatePieChartWithEmptyData() {
            ...
            try {
                ...
                fail("Should have thrown an IllegalArgumentException");
                assertEquals("No data in dataset.", e.getMessage());
            }
        }
        ...
        public void testCreatePieChartWithNullTitle() {
            ...
            try {
                ...
                fail("Shouldhave thrown an IllegalArgumentException");
                assertEquals("Null 'title' argument.", e.getMessage());
            }
        }
        ...
        public void testSetPieChartTitle() {
            ...
            assertEquals("New Test Chart", chart.getTitle().getText());
        }
        ...
        public void testSetPieChartSectionOutlineStroke() {
            ...
            assertEquals(new BasicStroke(2), plot.getSectionOutlineStroke("A"));
        }
        ...
        public void testSetPieChartSectionExplodePercent() {
            ...
            assertEquals(0.1, plot.getExplodePercent("A"), 0.0001);
        }
        ...
        public void testSetPieChartSectionLabelFont() {
            ...
            assertEquals(new Font("Arial", Font.PLAIN, 12), plot.getLabelFont());
        }
        ...
        public void testSetPieChartSectionLabelOutlineStroke() {
            ...
            assertEquals(new BasicStroke(2), plot.getLabelOutlineStroke());
        }
        ...
        public void testSetPieChartSectionLabelLinkMargin() {
            ...
            assertEquals(0.1, plot.getLabelLinkMargin(), 0.0001);
        }
        ...
        public void testSetPieChartSectionLabelLinkStroke() {
            ...
            assertEquals(new BasicStroke(2), plot.getLabelLinkStroke());
        }
        ...
        public void testSetPieChartSectionRotationAngle() {
            ...
            assertEquals(45, plot.getStartAngle(), 0);
        }
        ...
        public void testSetPieChartSectionInteriorGap() {
            ...
            assertEquals(0.05, plot.getInteriorGap(), 0.0001);
        }
        ...
        public void testSetPieChartSectionShadowXOffset() {
            ...
            assertEquals(5, plot.getShadowXOffset(), 0);
        }
        ...
        public void testSetPieChartSectionShadowYOffset() {
            ...
            assertEquals(5, plot.getShadowYOffset(), 0);
        }
        ...
        public void testSetPieChartSectionOutlinePaint() {
            ...
            assertEquals(Color.BLACK, plot.getSectionOutlinePaint("A"));
        }
        ...
        public void testSetPieChartSectionShadowGenerator() {
            ...
            assertNotNull(plot.getShadowGenerator());
        }
